<div class="card">
    <div class="card-header">{{ __('Borrar compte') }}</div>

    <div class="card-body">
        <div class="mb-3">
            {{ __('Un cop el teu compte sigui eliminat, tots els seus recursos i dades seran suprimits de manera permanent. Abans d\'eliminar el teu compte, descarrega qualsevol dada o informació que vulguis conservar.') }}
        </div>
